...
$s = "SELECT * from client where Etat='I'";
...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">  
	<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-5 mb-10 border-bottom">
        <h3 >les invitations de rejoindre votre magasin</h3>
  </div>
        ...
        <?php
            ...
            ?>
                <tr>
                    ...
                    <td><button class="btn btn-success btn-sm px-3"><a href="valideInscrits.php?GetId=<?php echo $id ?>"><i class="fas fa-check-circle" style="color:green;"></a></button></td>
                    <td><button class="btn btn-danger btn-sm px-3"><a href="deleteInscrits.php?Del=<?php echo $id ?>"><i class="fas fa-trash"></i></a>supprimer</button></td>
                </tr>
            <?php 
                }
            ?>
